#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-07-12 10:20:35 (ywatanabe)"
# File: /ssh:sp:/home/ywatanabe/proj/scitex_repo/src/scitex/db/_SQLite3.py
# ----------------------------------------
import os
__FILE__ = (
...
THIS_FILE = "/home/ywatanabe/proj/scitex_repo/src/scitex/db/_sqlite3/_SQLite3.py"
...
class SQLite3(
    ...
    def __init__(
        ...
        use_temp : bool, optional
            Whether to use a temporary copy of the database (default: False)
        compress_by_default : bool, optional
            Whether to compress BLOB data by default when not explicitly specified (default: False)
        """
